  ...
  public: {
    Tables: {
      ...
      pickup_locations: {
        ...
        Relationships: [
          {
            foreignKeyName: "pickup_locations_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      tenants: {
        Row: {
          ...
          created_at: string | null
          email: string | null
          enable_deals: boolean | null
          enable_events: boolean | null
          enable_magazine: boolean | null
          enable_restaurants: boolean | null
    ...
    Functions: {
      ...
      archive_expired_deals: { Args: never; Returns: undefined }
      calculate_distance: {
